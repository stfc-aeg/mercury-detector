...
install_requires = [
    'odin_control @ git+https://github.com/odin-detector/odin-control@1.3.0#egg=odin_control',
    'odin_sequencer @ git+https://github.com/stfc-aeg/odin-sequencer@0.2.0#egg=odin_sequencer',
    'pyzmq>=22.0',
    'msgpack>=1.0'
]
